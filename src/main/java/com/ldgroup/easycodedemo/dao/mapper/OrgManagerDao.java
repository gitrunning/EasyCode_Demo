...
/**
 * 组织主管关联(OrgManager)表数据库访问层
 *
 * @author makejava
 * @since 2020-06-28 14:35:58
 */
public interface OrgManagerDao extends MyBaseDao<OrgManager> {
     ...
     * @return 对象列表
     */
    List<OrgManager> queryAllByLimit(@Param("offset") int offset, @Param("limit") int limit);
     ...
     * @return 对象列表
     */
    List<OrgManager> queryAll(OrgManager orgManager);
     ...
     * @return 影响行数
     */
    int update(OrgManager orgManager);
